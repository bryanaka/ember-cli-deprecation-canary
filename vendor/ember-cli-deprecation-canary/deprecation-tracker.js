(function() {
  ...
  if (!EmberDebug || !deprecationWorkflow || !deprecationWorkflow.config || !deprecationWorkflow.config.workflow) {
    throw new Error(`Ember and Ember CLI Deprecation Workflow is required to use Ember CLI Deprecation Canary`);
  }

  var hasOwnProperty = Object.prototype.hasOwnProperty;

  function DeprecationTracker(workflow) {
  ...
  window.deprecationWorkflow.canary.DeprecationTracker = DeprecationTracker;
})();
